...
Every optional aside in this book, in reading order, for the day one of them stuck with you and you want to find it again.

| Chapter | What it covers |
|---|---|
| [Framework, CMS, or Headless?](ch01-01-framework-cms-or-headless.md) | Why frameworks, CMSes, and API tools share the same language features under different packaging |
...
| [Craft CMS](ch03-04-craft-cms.md) | Dynamic property access behind flexible content fields |
...
| [Laravel Nova](ch05-05-laravel-nova.md) | Why a paid license changes nothing in the package mechanism |
...
| [Laravel Sanctum](ch06-02-laravel-sanctum-resources.md) | Why tokens are hashed differently from passwords |
...
| [WordPress Media Library](ch08-03-wordpress-media-library.md) | Eager thumbnail generation with GD/Imagick |
| [WooCommerce](ch09-01-woocommerce.md) | Commerce data modeled on the same `wp_posts`/`wp_postmeta` tables |
| [Sylius](ch09-02-sylius.md) | Built from reusable Symfony components, not from scratch |
...
| [Symfony Messenger](ch11-02-symfony-messenger.md) | Routing messages to handlers through PHP's type system |
...
| [WordPress Multisite/WPML](ch13-02-wordpress-multisite-wpml.md) | Two structural answers to two different problems |
...
| [WordPress Testing](ch14-03-wordpress-phpunit-phpcs-wpscan.md) | Test isolation through database transaction rollback |
...
| [Blackfire](ch15-04-blackfire-profiling.md) | Profiling through a Zend Engine extension |
| [Laravel Forge/Vapor](ch16-01-laravel-forge-vapor.md) | Statelessness as the enabler of serverless deployment |
| [Cloud Hosting](ch16-02-cloud-hosting-aws-gcp-azure.md) | The same PHP process, whichever cloud runs it |
...
| [Nextcloud AIO](ch16-05-nextcloud-aio-docker.md) | Container orchestration through the mastercontainer pattern |
