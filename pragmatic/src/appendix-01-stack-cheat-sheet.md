...
One page: the need on the left, the pick on the right. A `$` marks anything that is not open source. Where two picks appear, the first is usually the faster start.

| You need to ship... | Reach for | Chapter |
|---|---|---|
| A custom application with business logic of its own | Laravel or Symfony | [Ch. 1](ch01-01-framework-cms-or-headless.md) |
| A marketing site or blog the client edits themselves | WordPress | [Ch. 3](ch03-01-wordpress-block-themes.md) |
...
| An AI feature added to an existing app | Laravel Prism or Symfony AI Bundle | [Ch. 12](ch12-00-shipping-an-ai-feature.md) |
| Several languages or several regional sites | TYPO3, WPML, or Symfony Translation | [Ch. 13](ch13-00-shipping-multi-language-multi-site.md) |
...
| Errors seen in production | Sentry (or Flare `$`) | [Ch. 14](ch14-05-sentry-flare-error-tracking.md) |
| More throughput without rewriting the app | FrankenPHP / Laravel Octane | [Ch. 15](ch15-01-frankenphp-laravel-octane.md) |
| Finding the performance bottleneck | Blackfire `$` | [Ch. 15](ch15-04-blackfire-profiling.md) |
...
| Deploying several frameworks the same way | Platform.sh `$` | [Ch. 16](ch16-03-platform-sh.md) |
| Deploying WordPress where downtime costs money | Kinsta or WP Engine `$` | [Ch. 16](ch16-04-wordpress-managed-hosting.md) |
