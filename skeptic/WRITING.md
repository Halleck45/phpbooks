# PHP in 2026, the Facts: Writing Guide

This file is the editorial contract for the skeptical evaluator book. Read it before writing or editing any chapter. The general house style (rhythm, narrative, no filler) lives in the `book-style` skill and applies on top of everything here. This book is published under the umbrella of the PHP Foundation and is meant to sit on php.net, so it is held to a higher standard than the other books in this repository: every sentence must survive a hostile reader with a search engine.

## 1. The reader

**The Skeptical Evaluator. "Impress me with scale, not hype."**

She is a working engineer, or an architect, who sees PHP as unglamorous. She compares it with the languages people talk about this year. She has heard the jokes and half believes them. She will learn PHP if, and only if, she is convinced it is worth her time, and what convinces her is evidence: commercial use at scale, throughput and latency figures, reputable organisations running it in production, a credible future.

She is not hostile, she is busy. She reads the way a due-diligence reviewer reads: she looks for the source behind a number, she notices when a comparison is cherry-picked, she trusts a document more when it states its own limits. One unsourced superlative and she closes the tab.
...
1. **The evaluator's question first.** The first paragraph states the question and gives the short, sourced answer. Bold the key sentence.
