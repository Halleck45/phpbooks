...
- Nextcloud "500K+ servers": Nextcloud, 2025 wrap-up, 11 December 2025. https://nextcloud.com/blog/nextcloud-2025-wrap-up/
...
- Matomo "more than 1.4 million websites": Matomo, 1 September 2026. https://matomo.org/blog/2026/09/matomo-launches-reseller-partner-programme/
- Wikimedia 19.4 billion page views per month: Wikimedia Foundation audited financial statements, fiscal year 2023 to 2024. https://upload.wikimedia.org/wikipedia/foundation/f/f6/Wikimedia_Foundation_2024_Audited_Financial_Statements.pdf
...
- Wikimedia end of HHVM in production: Phabricator T176370, resolved 23 November 2019. https://phabricator.wikimedia.org/T176370
...
- WordPress VIP 2.4 trillion requests per year and 22 billion on election night 2024 (marketing page, CDN included): wpvip.com, checked 17 September 2026. https://wpvip.com/capabilities/performance/
...
- Etsy on PHP 7 in 2016: talk "Deploying PHP 7", PHP Conference Philippines, 13 October 2016. https://talks.php.net/ph16
...
- JetBrains 17 percent used (13th language), 9 percent primary (9th), "long-term decline": JetBrains State of Developer Ecosystem 2025, 24,534 respondents, fielded April to June 2025. https://devecosystem-2025.jetbrains.com/
...
- PHP fourth, tied with C#: RedMonk language rankings, January 2026, published 14 April 2026. https://redmonk.com/sogrady/2026/04/14/language-rankings-1-26/
...
- JIT four-fold gain on Mandelbrot: RFC JIT, wiki.php.net, 2019. https://wiki.php.net/rfc/jit

## Concurrency

- Fibers: "all fibers exist within a single thread", "blocking code ... will continue to block the entire process": RFC Fibers, wiki.php.net, accepted 50 to 14, March 2021. https://wiki.php.net/rfc/fibers
- AMPHP, ReactPHP: amphp.org and reactphp.org, checked 17 September 2026.
- TechEmpower Round 23 plaintext test figures: see the previous section; raw table in `charts/raw/techempower-r23-plaintext.csv`.
- "Concurrency Support in the PHP Engine" RFC under discussion: wiki.php.net RFC index, checked 17 September 2026. https://wiki.php.net/rfc The earlier "PHP True Async" RFC shows status Canceled, last edited 22 July 2026. https://wiki.php.net/rfc/true_async

## The Language in 2026

- Every feature and its version: php.net release pages and the fact sheet in the polyglot book's writing guide, both checked against php.net. Examples were run under PHP 8.5 with the official Docker image on 17 September 2026.
...
- `composer audit` introduced in Composer 2.4.0, 16 August 2022: getcomposer.org changelog. https://getcomposer.org/changelog/2.4.0 Documentation: https://getcomposer.org/doc/03-cli.md#audit
...
- Signed release tags since April 2012: php.net GPG keys page. https://www.php.net/gpg-keys.php

## Governance and Longevity

- RFC process and voting (two-thirds majority, two weeks of discussion, two weeks of voting, who votes): wiki.php.net, "How to create an RFC" and "Voting". https://wiki.php.net/rfc/howto and https://wiki.php.net/rfc/voting
...
- RFC counts per version (31 for 8.4, 19 for 8.5, 29 for 8.6 as of September 2026): php.watch RFC index, a secondary source. https://php.watch/rfcs
- Release dates of every version: php.net release archive and changelogs, checked 17 September 2026. https://www.php.net/releases/ and https://www.php.net/ChangeLog-8.php
- Support policy and current windows: php.net, supported versions and end of life pages, checked 17 September 2026. https://www.php.net/supported-versions.php and https://www.php.net/eol.php
- Release cycle update (security support extended, windows aligned to 31 December; votes 31 to 0 and 33 to 0): RFC, wiki.php.net, accepted April 2024. https://wiki.php.net/rfc/release_cycle_update
- PHP 8.6 schedule (GA 19 November 2026, feature freeze 22 September 2026): wiki.php.net, PHP 8.6 release schedule. https://wiki.php.net/todo/php86
- php-src activity (5,316 commits and 171 authors on master in the twelve months to 17 September 2026; 1,644 contributors): measured on a clone of github.com/php/php-src with `git log`, and the GitHub contributors API, 17 September 2026.
- The PHP Foundation founding (22 November 2021, ten founding members, the departure that triggered it): JetBrains, 22 November 2021, and thephp.foundation. https://blog.jetbrains.com/phpstorm/2021/11/the-php-foundation/ and https://thephp.foundation/
...
- Sovereign Tech Agency grants (205,000 euros in 2023; 223,680 euros in 2025): sovereign.tech. https://www.sovereign.tech/tech/php and https://www.sovereign.tech/tech/php-2025
