...
One more thing worth knowing early, even though we won't use it in earnest until [Chapter 13](ch13-00-functional-features.md): functions in PHP are values too. You can hold one in a variable and call it:
