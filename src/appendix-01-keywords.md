...
`use` shows up in two groups above because it does two unrelated jobs: importing names from a namespace ([Chapter 7](ch07-03-use-keyword.md)) and capturing variables into a closure ([Chapter 15](ch15-01-closures.md)). Same word, same reservation, different context.
