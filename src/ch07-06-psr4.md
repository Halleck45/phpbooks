...
<img src="images/ch07-icon.svg" alt="Separating Classes into Different Files (PSR-4) illustration" width="72">
...
This regenerates the files inside `vendor/composer/`, including the PSR-4 map we peeked at in [Packages and Autoloading](ch07-02-packages-and-autoloading.md). From this point on, `require 'vendor/autoload.php'` finds your own `App\` classes exactly the way it already found any third-party package you'd installed.
