...
PHP publie une nouvelle version mineure à peu près une fois par an. Chaque version reçoit environ deux ans de support actif (nouvelles fonctionnalités, corrections de bugs, correctifs de sécurité), puis à peu près un an de support limité à la sécurité avant d'atteindre sa fin de vie. Passé ce point, la faire tourner en production revient à faire tourner un logiciel sans correctifs, ni plus ni moins.
